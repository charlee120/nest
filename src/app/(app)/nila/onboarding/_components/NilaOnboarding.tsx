...
function NilaOrb() {
  return (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" aria-hidden="true">
      ...
      <path
        d="M60 44 Q72 50 70 62 Q67 73 56 73 Q47 70 50 60"
        stroke="#2F4C3A"
        strokeWidth="1.8"
        strokeLinecap="round"
        fill="none"
...
function Cross() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
      <path
        d="M3.5 3.5 L 10.5 10.5 M10.5 3.5 L 3.5 10.5"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
      />
...
interface NilaOnboardingProps {
  userName: string
  userInitial: string
}

export default function NilaOnboarding({ userName, userInitial }: NilaOnboardingProps) {
  const [pending, startTransition] = useTransition()

  function handleBegin() {
    startTransition(async () => {
      await markNilaOnboarded()
    })
  }
      ...
      <div className="ns-main ns-main--onboard">
        ...
        <div className="ns-onboard">
          ...
          <p className="ns-onboard__body">
            Nila is an AI companion — not a therapist. Think of a friend who actually listens,
            without judgment, and never asks you to perform. Everything you say here stays private.
          </p>
          ...
          <div className="ns-cancant">
            <div className="ns-cancant__col">
              ...
              <ul>
                <li>
                  <span className="ns-cancant__icon ns-cancant__icon--yes">
                    <Check />
                  </span>
            ...
            <div className="ns-cancant__col">
              ...
              <ul>
                <li>
                  <span className="ns-cancant__icon ns-cancant__icon--no">
                    <Cross />
                  </span>
          ...
          <button
            className="ns-btn ns-btn--primary ns-onboard__begin"
            onClick={handleBegin}
            disabled={pending}
          >
